...
Tox.prototype.bootstrap = function(address, port, publicKey, callback) {
  this._performBootstrap({
    api: this.getLibrary().tox_bootstrap.async,
...
Tox.prototype.bootstrapSync = function(address, port, publicKey) {
  this._performBootstrap({
    api: this.getLibrary().tox_bootstrap,
    args: [address, port, publicKey],
    async: false
  });
};
...
Tox.prototype.addTCPRelay = function(address, port, publicKey, callback) {
  this._performBootstrap({
    api: this.getLibrary().tox_add_tcp_relay.async,
    args: [address, port, publicKey],
    async: true,
    callback: callback
  });
...
Tox.prototype.addTCPRelaySync = function(address, port, publicKey) {
  this._performBootstrap({
    api: this.getLibrary().tox_add_tcp_relay,
    args: [address, port, publicKey],
    async: false
  });
};
...
Tox.prototype.getAddress = function(callback) {
  this._performGetter({
    api: this.getLibrary().tox_self_get_address.async,
    format: 'raw',
...
Tox.prototype.getAddressSync = function() {
  return this._performGetter({
    api: this.getLibrary().tox_self_get_address,
    format: 'raw',
    size: consts.TOX_FRIEND_ADDRESS_SIZE
  });
};
...
Tox.prototype.setName = function(name, callback) {
  this._performSetter({
    api: this.getLibrary().tox_self_set_name.async,
    data: name,
    async: true, callback: callback
  });
};
...
Tox.prototype.setNameSync = function(name) {
  this._performSetter({
    api: this.getLibrary().tox_self_set_name,
    data: name
  });
};
...
Tox.prototype.getNameSize = function(callback) {
  this._performSizeGetter({
    api: this.getLibrary().tox_self_get_name_size.async,
    async: true, callback: callback
  });
};
...
Tox.prototype.getNameSizeSync = function() {
  return this._performSizeGetter({
    api: this.getLibrary().tox_self_get_name_size
  });
};
...
Tox.prototype.getNameSync = function() {
  return this._performGetter({
    api: this.getLibrary().tox_self_get_name,
    format: 'string',
...
Tox.prototype.setStatusMessage = function(statusMessage, callback) {
  this._performSetter({
    api: this.getLibrary().tox_self_set_status_message.async,
    data: statusMessage,
    async: true, callback: callback
  });
};
...
Tox.prototype.setStatusMessageSync = function(statusMessage) {
  this._performSetter({
    api: this.getLibrary().tox_self_set_status_message,
    data: statusMessage
  });
};
...
Tox.prototype.getStatusMessageSize = function(callback) {
  this._performSizeGetter({
    api: this.getLibrary().tox_self_get_status_message_size.async,
    async: true, callback: callback
  });
};
...
Tox.prototype.getStatusMessageSizeSync = function() {
  return this._performSizeGetter({
    api: this.getLibrary().tox_self_get_status_message_size
  });
};
...
Tox.prototype.getStatusMessage = function(callback) {
  this._performGetter({
    api: this.getLibrary().tox_self_get_status_message.async,
    format: 'string',
...
Tox.prototype.getStatusMessageSync = function() {
  return this._performGetter({
    api: this.getLibrary().tox_self_get_status_message,
    format: 'string',
...
Tox.prototype.sendLosslessPacket = function(friendnum, data, callback) {
  ...
  this.getLibrary().tox_friend_send_lossless_packet.async(
    ...
    if(!err && !res) {
      err = errors.getToxNotSuccessfulError();
    }
...
Tox.prototype.sendLosslessPacketSync = function(friendnum, data) {
  ...
  var err = errors.getToxFriendCustomPacketError(eptr.deref());
  if(err) throw err;

  if(!success) {
    throw errors.getToxNotSuccessfulError();
  }
};
...
Tox.prototype._performBootstrap = function(opts) {
  ...
  if(async) {
    ...
    api(this.getHandle(), address, port, publicKey, eptr, function(err, success) {
    ...
    this._checkHandleSync();
    var success = api(this.getHandle(), address, port, publicKey, eptr);
  ...
  if(async) {
    ...
    size(function(err, size) {
      ...
      if(!err) {
        ...
        api(handle, buffer, function(err) {
...
Tox.prototype._performSizeGetter = function(opts) {
  ...
  if(async) {
    if(!this._checkHandle(callback)) return;
    api(this.getHandle(), function(err, size) {
...
Tox.prototype._performSetter = function(opts) {
  ...
  if(async) {
    if(!this._checkHandle(callback)) return;
    api(this.getHandle(), data, size_t(data.length), eptr, function(err, success) {
      var terr = errors.getToxSetInfoError(eptr.deref());
      if(!err && terr) err = terr;
      if(!err && !success) err = errors.getToxNotSuccessfulError();
      if(callback) {
        callback(err);
    ...
    this._checkHandleSync();
    var success = api(this.getHandle(), data, size_t(data.length), eptr),
        err = errors.getToxSetInfoError(eptr.deref());
    if(err) throw err;
