 ...
 * @class
 * @param {ToxFriend} friend - Friend
 * @param {String} what - Name of property that changed, should be one of
 *                        ['name', 'statusMessage', 'status', 'connectionStatus'].
 */
var FriendChangedClientEvent = function(friend, what) {
  this.type = 'FriendChangedClientEvent';
  this._friend = friend;
  this._what = what;
};
 ...
 * @return {ToxFriend} Friend
 */
FriendChangedClientEvent.prototype.friend = function() {
  return this._friend;
};
 ...
 * @return {String} What
 */
FriendChangedClientEvent.prototype.what = function() {
  return this._what;
};

module.exports = {
  BootstrapClientEvent: BootstrapClientEvent,
  FriendChangedClientEvent: FriendChangedClientEvent,
