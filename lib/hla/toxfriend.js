...
ToxFriend.prototype._initialize = function() {
  ...
  if(tox.hasFriendSync(id)) {
    ...
    this._publicKey = tox.getFriendPublicKeySync(id);
    this._publicKeyHex = tox.getFriendPublicKeyHexSync(id).toUpperCase();
  } else {
...
/**
 * Get the friend status message.
 * @return {String} Status message
 */
ToxFriend.prototype.statusMessage = function() {
 ...
 */
ToxFriend.prototype.status = function() {
  return this._status;
};
 ...
 */
ToxFriend.prototype.publicKey = function() {
  return this._publicKey;
};

/**
 * Get the friend public key as a hex string.
 * @return {String} Public key hex string
 */
ToxFriend.prototype.publicKeyHex = function() {
