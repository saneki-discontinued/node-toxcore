 ...
 * @param {Buffer} data
 */
var FriendLosslessPacketEvent = function(friendnum, data){
  this.type = 'FriendLosslessPacketEvent';
  this._friendnum=friendnum;
  this._data=data;
};
 ...
 * @return {Number} Friend number
 */
FriendLosslessPacketEvent.prototype.friend = function(){
  return this._friendnum;
};

/**
 * Get the lossless data.
 * @return {Buffer} Data
 */
FriendLosslessPacketEvent.prototype.data = function(){
  return this._data;
};
 ...
 */
FriendLosslessPacketEvent.prototype.length = function(){
...
module.exports = {
  ...
  FriendLosslessPacketEvent: FriendLosslessPacketEvent
};
