...
console.log('var TOX_KEY_SIZE=' + TOX_KEY_SIZE);
...
Tox.prototype.load = function(buffer, callback) {
  ...
  this.toxcore.tox_load.async(this.handle, buffer, buffer.length, function(err, res) {
    if(!err && res < 0) {
      err = new Error('Negative return value for tox_load');
      err.tox = { name: 'tox_load', returned: res };
    }
...
Tox.prototype.addFriendSync = function(addr, message) {
  ...
  if(friend < 0) {
    ...
    err.tox = { name: 'tox_add_friend', returned: friend };
    throw err;
  }
...
Tox.prototype.addFriendNoRequestSync = function(pubkeybuf) {
  ...
  if(friendnum < 0) {
    var err = new Error('Negative return value for tox_add_friend_norequest');
    err.tox = { name: 'tox_add_friend_norequest', returned: friendnum }; 
    throw err;
  }
...
Tox.prototype.addGroupchatSync = function() {
  ...
  if(groupnum < 0) {
    var err = new Error('Negative return value for tox_add_groupchat');
    err.tox = { name: 'tox_add_groupchat', returned: groupnum };
    throw err;
  }
...
Tox.prototype.getGroupchatPeernameSync = function(groupnum, peernum) {
  ...
  if(len < 0) {
    var err = new Error('Negative return value for tox_group_peername');
    err.tox = { name: 'tox_group_peername', returned: len };
    throw err;
  }
...
Tox.prototype.joinGroupchatSync = function(friendnum, data) {
  ...
  if(groupnum < 0) {
    var err = new Error('Negative return value for tox_join_groupchat');
    err.tox = { name: 'tox_join_groupchat', returned: groupnum };
    throw err;
  }
...
Tox.prototype.setGroupchatTitle = function(groupnum, title, callback) {
  ...
  this.toxcore.tox_group_set_title.async(this.handle, groupnum, titleBuffer, title.length, function(err, res) {
    if(!err && res !== 0) {
      var err = new Error('Non-zero return value for tox_group_set_title');
      err.tox = { name: 'tox_group_set_title', returned: res };
    }
...
Tox.prototype.getGroupchatTitle = function(groupnum, callback) {
  ...
  this.toxcore.tox_group_get_title.async(this.handle, groupnum, buffer, buffer.length, function(err, res) {
    if(!err && res < 0) {
      err = new Error('Negative return value for tox_group_get_title');
      err.tox = { name: 'tox_group_get_title', returned: res };
    }
...
Tox.prototype.getGroupchatTitleSync = function(groupnum) {
  ...
  if(length < 0) {
    var err = new Error('Negative return value for tox_group_get_title');
    err.tox = { name: 'tox_group_get_title', returned: length };
    throw err;
  }
...
Tox.prototype.getGroupchatPeerCountSync = function(groupnum) {
  ...
  if(count < 0) {
    var err = new Error('Negative return value for tox_group_number_peers');
    err.tox = { name: 'tox_group_number_peers', returned: count };
    throw err;
  }
...
Tox.prototype.getGroupchatPeerNamesSync = function(groupnum) {
  ...
  if(peers < 0) {
    var err = new Error('Negative return value for tox_group_get_names');
    err.tox = { name: 'tox_group_get_names', returned: peers };
    throw err;
  }
...
Tox.prototype.newFileSender = function(friendnum, filesize, filename, callback) {
  ...
  this.toxcore.tox_new_file_sender.async(
    ...
    if(!err && res < 0) {
      err = new Error('Negative return value for tox_new_file_sender');
      err.tox = { name: 'tox_new_file_sender', returned: res };
    }
...
Tox.prototype.sendFileControl = function(friendnum, sendReceive, filenum, messageId, data, callback) {
  ...
  this.toxcore.tox_file_send_control.async(
    ...
    if(!err && res !== 0) {
      err = new Error('Non-zero return value for tox_file_send_control');
      err.tox = { name: 'tox_file_send_control', returned: res };
    }
...
Tox.prototype.sendFileData = function(friendnum, filenum, data, callback) {
  ...
  this.toxcore.tox_file_send_data.async(
    ...
    if(!err && res !== 0) {
      err = new Error('Non-zero return value for tox_file_send_data');
      err.tox = { name: 'tox_file_send_data', returned: res };
    }
...
Tox.prototype.getFileDataSize = function(friendnum, callback) {
  ...
  this.toxcore.tox_file_data_size.async(this.handle, friendnum, function(err, res) {
    if(!err && res < 0) {
      err = new Error('Non-zero return value for tox_file_data_size');
      err.tox = { name: 'tox_file_data_size', returned: res };
    }
...
Tox.prototype.getFileDataSizeSync = function(friendnum) {
  ...
  if(size < 0) {
    err = new Error('Non-zero return value for tox_file_data_size');
    err.tox = { name: 'tox_file_data_size', returned: size };
    throw err;
  }
...
Tox.prototype.bootstrapFromAddress = function(address, port, publicKey, callback) {
  ...
  this.toxcore.tox_bootstrap_from_address.async(
    ...
    if(!err && res !== 1) {
      err = new Error('Non-one return value for tox_bootstrap_from_address');
      err.tox = { name: 'tox_bootstrap_from_address', returned: res };
    }
...
Tox.prototype.addTCPRelay = function(address, port, publicKey, callback) {
  ...
  this.toxcore.tox_add_tcp_relay.async(
    this.handle, address, port, publicKey, function(err, res) {
    if(!err && res !== 1) {
      err = new Error('Non-one return value for tox_add_tcp_relay');
      err.tox = { name: 'tox_add_tcp_relay', returned: res };
    }
...
Tox.prototype.initGroupTitleCb = function() {
  ...
  var wrapper = function(handle, groupnum, peernum, titlebuf, length, userdata) {
    ...
    _this.emit('groupTitle', new toxEvents.GroupTitleEvent(groupnum, peernum, title));
  };
...
Tox.prototype.hash = function(buf, callback) {
  ...
  this.toxcore.tox_hash.async(outbuf, buf, buf.length, function(err, res) {
    if(!err && res !== 0) {
      err = new Error('Non-zero return value for tox_hash');
      err.tox = { name: 'tox_hash', returned: res };
    }
